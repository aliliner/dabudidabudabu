...
with st.echo(code_location='below'):
    ...
    if level == "Continents":
        st.write("In this section I give you the opportunity to compare several continents. You can choose regions in legend.")
        ...
        st.write("""In this section I give you the opportunity to compare several countries. You can choose as many countries as you want. On the graph, the size of the country reflects its population. """)
